...
from ._biased_summarizer import BiasedAbstractSummarizer


class BiasedTextRankSummarizer(BiasedAbstractSummarizer):
    ...
    def score_biases(self, sentence):
        ...
        for function in self.bias_functions:
            bias += int(function[0](sentence))*function[1]
        return bias
       ...
       # print('Printing sentences: ')
        ...
        for sentence in document.sentences:
           # print(sentence.words)
            ratings[sentence] += self.score_biases(sentence._text) 
